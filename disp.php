...
<div style="width: 60%; margin: 0 auto; margin-top: 40px; padding: 5px;">

<div style="float: left; width: 300px; font: normal 15px \'Arial\'">
<h3>Waverly Cabinets</h3>
55 West Seventh Street<br>
Wyoming, PA 18644<br>
570-430-4396<br>
...
<h2>Ship To</h2> <div style="float: right;"><a href="'.$order->get_shipping_address_map_url( ).'" target="_blank">Map</a></div>
