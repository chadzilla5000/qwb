...
//$dsn = 'mysql://root:1234@localhost/quickbooks_server';
	...
	$xml = '<?xml version="1.0" encoding="utf-8"?>
		...
		<QBXML>
			<QBXMLMsgsRq onError="stopOnError">
				<CustomerAddRq requestID="' . $requestID . '">
					<CustomerAdd>
						<Name>NETHOST INC, LLC (' . mt_rand() . ')</Name>
						<CompanyName>NETHOST, LLC</CompanyName>
						<FirstName>IKRAM</FirstName>
						<LastName>KORESHI</LastName>
						<BillAddress>
							<Addr1>TYSONS, LLC</Addr1>
						...
						<Email>ikram@nethost.com</Email>
						<Contact>Mr. Ikram</Contact>
					</CustomerAdd>
				</CustomerAddRq>
			</QBXMLMsgsRq>
		</QBXML>';
