...
//	$record = mysql_fetch_array(mysql_query("SELECT * FROM my_customer_table WHERE your_customer_ID_field = " . (int) $ID));
	$record = mysql_fetch_array(mysql_query("SELECT * FROM my_customer_table WHERE id = 3"));
		...
		<QBXML>
			<QBXMLMsgsRq onError="stopOnError">
				<CustomerAddRq requestID="' . $requestID . '">
					<CustomerAdd>
						<Name>' . $record['fname'] . '</Name>
						<CompanyName>' . $record['name'] . '</CompanyName>
					</CustomerAdd>
				</CustomerAddRq>
			</QBXMLMsgsRq>
		</QBXML>';
	...
	$xml = '<?xml version="1.0" encoding="utf-8"?>
		...
		<QBXML>
			<QBXMLMsgsRq onError="stopOnError">
				<CustomerAddRq requestID="' . $requestID . '">
					<CustomerAdd>
						<Name>Loop M (' . mt_rand() . ')</Name>
						<CompanyName>Majoris, Corp</CompanyName>
						<FirstName>Dorrian</FirstName>
						<LastName>Grey</LastName>
						<BillAddress>
							<Addr1>Majoris, Corp</Addr1>
							<Addr2>787 River Road</Addr2>
							<City>Garfankel</City>
							<State>MS</State>
							<PostalCode>58331</PostalCode>
							<Country>United States</Country>
						</BillAddress>
						<Phone>800-922-1103</Phone>
						<AltPhone>800-429-0021</AltPhone>
						<Fax>860-429-5183</Fax>
						<Email>dorian@majoris.com</Email>
						<Contact>Dorian Grey</Contact>
					</CustomerAdd>
				</CustomerAddRq>
			</QBXMLMsgsRq>
		</QBXML>';
