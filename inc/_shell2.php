...
<?php echo $pgcontent; ?>
	...
	<div class="Footer" style="dis___position: absolute; left: 0p; bottom: 0px; height: 20px; width: 99%;">Copyright &copy; WAVERLY CABINETS Inc. (2018-2023)&nbsp;&nbsp;&nbsp;All rights reserved</div>
</div>
</body>
</html>
<!-- End --><!-- BODY ENDS HERE -->
