...
function get_sitterow($row){
	...
	$ms = '
<tr><td rowspan="5" style="width: auto; text-align: center; color: #ccc; font-weight: normal; font-size: 11px;" title="ID: <!--<Id>-->
Дата-время публикации: <!--<ApplyDT>-->"> <img src="<!--<picpath>-->" style="max-width: 90px; max-height: 120px;">
	</td>
	...
	<td width="50%" colspan="2" rowspan="4" style="font-weight: normal; color: #363;"> <span style="color: #999;">Опыт <b><!--<Exper_Years>--></b> год(а) / лет</span><br> <!--<Exper_details>--></td>
</tr>	
<tr><td class="LCell" width="120"> Гражданство </td>
	<td><!--<Citizenship>--></td>
</tr>	
...
<tr><td class="LCell">Знание русского яз.</td>
	<td>
		<!--<Ruslang>-->
	</td>
</tr>	
<tr><td class="LCell">Район,округ</td>
	<td>
		<!--<Region>-->
	</td>
...
<tr><td style="background: none; border: none; height: 10px;"></td></tr>	
<!-- tr><td>' . $row["Id"]          . '</td>
	<td>' . $row["FName"]       . '</td>
	<td>' . $row["MName"]       . '</td>
	<td>' . $row["LName"]       . '</td>
