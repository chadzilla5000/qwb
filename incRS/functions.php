...
switch($brand){
	...
	case 'FL':
		$sff = substr($sku, -3);
		$row = mysqli_fetch_array(mysqli_query($dbh, "SELECT * FROM qc_factor WHERE BrAlias = 'FL' AND Misc = '$sff'", MYSQLI_ASSOC));
	break;
	case 'USCD':
